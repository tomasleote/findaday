...
module.exports = async function handler(req, res) {
    ...
    let title = 'Find a Day — Find the Best Date for Any Group Event';
    ...
    if (groupId) {
        ...
        const LANDING_PAGE_META = {
            ...
            '/group-event-planner': {
                ...
                description: "Find the best date for any group event. Everyone marks availability, Find a Day finds the overlap.",
            },
            '/team-scheduling': {
