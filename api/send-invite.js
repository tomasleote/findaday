...
module.exports = async function handler(req, res) {
    ...
    const personalLink = `${origin}?group=${groupId}&p=${participantId}`;
    ...
    <div style="font-family:Inter,sans-serif;max-width:560px;margin:0 auto;background:#0f172a;color:#f8fafc;border-radius:12px;overflow:hidden;">
      ...
      <div style="padding:32px;">
        <h2 style="margin:0 0 8px;font-size:20px;color:#f1f5f9;">Hi ${participantName || 'there'}!</h2>
        <p style="color:#cbd5e1;line-height:1.6;margin:0 0 24px;">
          You've been added to <strong style="color:#f1f5f9;">${groupName || 'a vacation planning group'}</strong>. 
        ...
        <div style="margin-bottom:24px;">
          ...
          <a href="${personalLink}" style="display:block;padding:12px 16px;background:#1e293b;border-radius:8px;color:#60a5fa;text-decoration:none;font-size:13px;word-break:break-all;">${personalLink}</a>
        </div>
  ...
  `;
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            to: participantEmail,
            subject: `You're invited to "${groupName || 'a trip'}" — mark your available dates`,
            html,
        });
