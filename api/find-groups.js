...
/**
 * Retrieve all group objects from the configured Firebase Realtime Database.
 *
 * Uses the REACT_APP_FIREBASE_DATABASE_URL (DB_URL) environment variable to locate the database and applies a 10-second network timeout.
 *
 * @returns {Object} An object mapping group IDs to group data; returns an empty object if the request fails, the response is not OK, or no groups exist.
 */
