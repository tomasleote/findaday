...
const features = [
    { name: 'Free to use', findaday: 'Yes, fully', doodle: 'Limited free tier', when2meet: 'Yes' },
    { name: 'No ads', findaday: 'Yes', doodle: 'No (heavy ads)', when2meet: 'Yes' },
    { name: 'Works on mobile', findaday: 'Yes', doodle: 'Broken experience', when2meet: 'Essentially unusable' },
    { name: 'Multi-day date ranges', findaday: 'Yes (core feature)', doodle: 'No (time slots only)', when2meet: 'No (hourly grid)' },
    { name: 'No account needed', findaday: 'Yes (all users)', doodle: 'Organizer needs account', when2meet: 'Yes (all users)' },
    { name: 'Visual heatmap', findaday: 'Color-coded overlap', doodle: 'Checkmark table', when2meet: 'Basic green grid' },
    { name: 'Post-poll workflow', findaday: 'Planned (voting + calendar)', doodle: 'None in free tier', when2meet: 'None' },
];
